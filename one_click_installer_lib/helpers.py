...
from . one_click_installerconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('one-click-installer')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('one_click_installer_lib')
