...
import gtk
import logging
logger = logging.getLogger('one_click_installer_lib')

from . helpers import get_builder, show_uri, get_help_uri
from . preferences import preferences

# This class is meant to be subclassed by OneClickInstallerWindow.  It provides
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseOneClickInstallerWindow object.
        """
        builder = get_builder('OneClickInstallerWindow')
        new_object = builder.get_object("one_click_installer_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a OneClickInstallerWindow object with it in order to finish
        initializing the start of the new OneClickInstallerWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('one-click-installer')
        except ImportError:
            pass
        ...
        try:
            from one_click_installer import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for one-click-installer."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for one-click-installer."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the OneClickInstallerWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the OneClickInstallerWindow is closed."""
